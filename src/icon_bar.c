...
static void
rstto_icon_bar_set_device_scale (RsttoIconBar *icon_bar);
static void
...
rstto_icon_bar_post_init (RsttoIconBar *icon_bar)
{
    ...
    g_signal_connect_swapped (window, "notify::device-scale",
...
rstto_icon_bar_set_device_scale (RsttoIconBar *icon_bar)
{
    ...
    g_object_get (gtk_widget_get_ancestor (widget, RSTTO_TYPE_MAIN_WINDOW),
                  "device-scale", &icon_bar->priv->device_scale, NULL);
